...
func easyjson171edd05DecodeCommonJwt(in *jlexer.Lexer, out *JwtClaims) {
...
func easyjson171edd05EncodeCommonJwt(out *jwriter.Writer, in JwtClaims) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JwtClaims) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson171edd05EncodeCommonJwt(&w, v)
...
func (v *JwtClaims) UnmarshalJSON(data []byte) error {
	...
	easyjson171edd05DecodeCommonJwt(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JwtClaims) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson171edd05DecodeCommonJwt(l, v)
}
